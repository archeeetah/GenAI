...
import { Bot, Loader2, AlertCircle, ArrowLeft } from 'lucide-react'; // Added AlertCircle, ArrowLeft
import Link from 'next/link';
import { useState } from 'react';
import { useAuth } from '../../lib/auth-context';
import { useRouter } from 'next/navigation';

// Extracted Google Icon for cleaner code
const GoogleIcon = () => (
...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // UX: Show a friendly error message to the user
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      {/* Background Grid Pattern (A11y: Hidden from screen readers) */}
      ...
      {/* Brand Header */}
      <div className="mb-8 text-center relative z-10 animate-in fade-in slide-in-from-top-4 duration-500">
        ...
        <h1 className="text-gray-600 text-lg font-medium">The Future of Agentic AI Lending</h1>
      </div>

      <Card className="w-full max-w-md border-none shadow-2xl shadow-blue-100/50 bg-white/80 backdrop-blur-sm relative z-10 animate-in fade-in zoom-in-95 duration-500">
        ...
        <CardContent className="space-y-6">
          ...
          <Button
            ...
            disabled={isLoading}
            className="w-full bg-blue-600 hover:bg-blue-700 text-white shadow-lg shadow-blue-200/50 transition-all hover:scale-[1.02] h-12 text-base font-medium"
          >
            {isLoading ? (
              <>
